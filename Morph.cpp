...
int Length;
//--------------------------------------------------------------------------------------------
void issRL78::abstractSimulation() {
	...
	//	cout << "Length is: " << Length << " step:" << step << endl;/////////////////////
		...
		checkFirstMap(type, BYTE[0], BYTE[1], BYTE[2], BYTE[3]);
		step = 0;
		//getchar();
	}
}
...
inline void issRL78::checkFirstMap(rl78InstructionType type, sc_lv <8>& Byte1, sc_lv <8>& Byte2, sc_lv <8>& Byte3, sc_lv <8>& Byte4) {
